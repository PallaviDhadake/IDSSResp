...
public class iClass
{
    ...
    {
        return System.Web.Configuration.WebConfigurationManager.ConnectionStrings["IDSSCon"].ConnectionString;
        //return "";
    }
    ...
    {
    //http://msg.msgclub.net/rest/services/sendSMS/sendGroupSms?AUTH_KEY=75ea83e662a546d71d713b3bcd7d93b&message=message&senderId=INTSYS&routeId=1&mobileNos=9999999999,9999999999&smsContentType=english
        try
        {
            WebClient wbClient = new WebClient();

            string baseUrl = "http://msg.msgclub.net/rest/services/sendSMS/sendGroupSms?AUTH_KEY=75ea83e662a546d71d713b3bcd7d93b&message=" + msgData + "&senderId=INTSYS&routeId=1&mobileNos=" + recNumber + "&smsContentType=english";
    ...
    public void SendMail(string fromEmail, string MailerName, string toEmail, string msgData, string mailSubject, string bccEmail, bool isHtmlEmail, string attachStr, string documentName)
    {
        try
        {
            ...
            smtp.Credentials = new NetworkCredential("admin@idssglobal.com", "idssAdmin@2017");
    ...
    public void EmailHttpMarkup(string fromEmail, string mailerName, string toEmail, string subjectLine, string subjectBrief, string msgData, string bccEMail, string attchStr, string docName)
    {
        try
        {
            ...
            strMail.Append("<a href=\"https://www.facebook.com/insyslabs\" style=\"margin-right:10px;\" ><img src=\"http://www.intellect-systems.com/images/icons/fb_mail.png\" title=\"Intellect Systems on Facebook\" /></a>");
            ...
            strMail.Append("<tr>");
            strMail.Append("<td style=\"padding:0px 0px 10px 0px;font-family:Arial,Sans-Serif;font-size:13px;line-height:1.5;color:#525252\">For any queries, complains or suggestions,<br/>please feel free to contact us at <a href=\"mailto:info@intellect-systems.com\" style=\"font-family:Arial,Sans-Serif;font-size:13px;\">info@intellect-systems.com</a></td>");
            strMail.Append("</tr>");
            strMail.Append("<tr>");
    ...
    public void ErrorLogHandler(string pageName, string funcName, string errMsg)
    {
        ...
        if (File.Exists(filePath))
        {
            ...
            strError.Append(DateTime.Now.Date.ToShortDateString());
